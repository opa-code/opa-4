...
uses globlib, MathLib, sysutils;

//public variables, used here and by linoplib, tracklib, opaorbit
var
  SPosEl, TimeOfFlight, Deflection, AbsDeflection,
...
// interpolation of long elements for better visualization:
  if SliceSet (Opi, l, soffset, dslice, nslice) then begin
    ...
    SlicingN (Opi, MatUni5, moffset, mslice, MatUni5, moffset, mslice, soffset, dslice, 0, false, nslice);
...
//rough approx for disp-prod, perhaps refine later
    ...
    if rot<>0 then begin
      ...
      SlicingN (Opi, MatUni5, moffset, mslice, MatUni5, moffset0, mslice0, soffset, dslice, d, true, nslice);
    end else  begin
      SlicingN (Opi, MatUni5, moffset, mslice, MatUni5, moffset0, mslice0, soffset, dslice, d, false, nslice);
    end;
  end;
end;
...
begin
  if SliceSet (Opi, l, soffset, dslice, nslice) then begin
    ...
    SlicingN (Opi, MatUni5, moffset, mslice, MatUni5, moffset, mslice, soffset, dslice, d, true, nslice);
  end;
end;
