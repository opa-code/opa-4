...
uses comvgraphlib, Graphics, elemlib, globlib, opatunediag, comauxlib, varlib, mathLib, grids, sysutils, stdctrls, forms;
...
begin
  ...
  GetNorm2Sigma;
  TransferMatrix :=MatUni5;
  TransferMatrix0:=MatUni5;
