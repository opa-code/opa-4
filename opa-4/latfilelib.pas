...
uses
  globlib, comauxlib, varlib, editorlib, mathlib,
...
// function compiling output string for bending magnets
  ...
  // later: move this to comaux unit and generalize, will be useful elsewhere too
...
// as-6.1.2021
  ...
  var
    ...
    // --> should go to comaux, because it is of general use.
    var
      i1, i2, err: integer;
      xv: real;
      vstr: string;
