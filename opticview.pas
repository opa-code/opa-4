...
uses
  ...
  OPAglobal, knobframe, OpticPlot, Opticstart, {OpticMom,} OpticEnvel, OpticTune,
  mathlib, EdElSet, OPAtune, asaux, Vgraph;
...
// pass table handle to opticPlot
  SetTabHandle(tab);
