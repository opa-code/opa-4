...
uses
  ...
  StdCtrls, ExtCtrls, OPAglobal, ASaux, OpticPlot, Math, Grids, knobframe, OpticMatchScan,
  asfigure;
...
{startup prodecure
  accepts handels to the plot (paintbox) and the knobs of opticView to be able to update them
...
// remember the use flags of the variables, they may be needed again in opticview/knobframe (?)
...
{recalculate the current optic that opticplot shows the correct thing}
    showBetas;
