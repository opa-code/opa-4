...
{dependancies:
uses (compile time):                                                    
  OPAChroma --> CSexLine, CHamLine, ChromGUILib1, ChromGUILib2, ChromLib
  CSexLine --> ChromGUILib, ChromLib [CHamLine no longer needed]
  ChromGUILib1 --> CHamLine, ChromLib;
  ChromGUILib2 --> ChromLib;
runtime:
  CHamLine --> CSexLine, ChromLib
}
...
uses
  ...
  CHamLine, CSexLine, ExtCtrls, ChromLib, ChromGUILib1, ChromGUILib2, OPAglobal, ASaux, MathLib,
  StdCtrls, OPAtune, OPAChromaSVector;
